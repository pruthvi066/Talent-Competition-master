                        ...
                        <div className="ui grid">
                            <div className="row">
                                <div className="sixteen wide center aligned padded column">
                                    {this.props.match.params.id ? <h1>Edit Job</h1> : this.props.match.params.copyId ? <h1>Copy Job</h1> : <h1>Create Job</h1>}
                                </div>
                            </div>
                                        ...
                                        <div className="ui grid">
                                            <div className="row">
                                                <div className="twelve wide column">
                                                    {this.props.match.params.id ? <label>* are required fields. Please don't leave any fields blank.</label>
                                                        :
